      ...
      <div class="container">
		...
		<section class="ftco-section">
          ...
          <div class="col-lg-8 ftco-animate">
          	<p>
              <img src="{{ asset('user/images/image_1.jpg')}}" alt="" class="img-fluid">
            </p>
            ...
            <p>
              <img src="{{ asset('user/images/image_2.jpg')}}" alt="" class="img-fluid">
            </p>
            ...
            <div class="about-author d-flex p-4 bg-light">
              <div class="bio mr-5">
                <img src="{{ asset('user/images/person_1.jpg')}}" alt="Image placeholder" class="img-fluid mb-4">
              </div>
              <div class="desc">
